...
radialoptions = {
    ...
    chart:{
        ...
        radialBar:{
            ...
            dataLabels:{
                    name:{show:!1},value:{offsetY:5,show:!0}
            }
        }
    }
},radialchart=new ApexCharts(document.querySelector("#radialchart-1"),radialoptions);radialchart.render();
...
radialoptions={
    series:[54],
    chart:{
        type:"radialBar",width:72,height:72,sparkline:{
            enabled:!0
        }
    },dataLabels:{
        enabled:!1
...
},chart=new ApexCharts(document.querySelector("#mixed-chart"),options);chart.render();
options={
    chart:{
        height:350,
        type:"radialBar"
